...
if("TRUE" STREQUAL "TRUE")
  set(libmavconn_SOURCE_PREFIX /home/zak/offbplus_ws/src/mavros/libmavconn)
  set(libmavconn_DEVEL_PREFIX /home/zak/offbplus_ws/devel)
  ...
  set(libmavconn_INSTALL_PREFIX /home/zak/offbplus_ws/install)
...
if(NOT "/home/zak/offbplus_ws/src/mavros/libmavconn/include;/usr/include;/opt/ros/kinetic/include " STREQUAL " ")
  set(libmavconn_INCLUDE_DIRS "")
  set(_include_dirs "/home/zak/offbplus_ws/src/mavros/libmavconn/include;/usr/include;/opt/ros/kinetic/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'libmavconn' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/zak/offbplus_ws/src/mavros/libmavconn/${idir}'.  ${_report}")
    endif()
    _list_append_unique(libmavconn_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "mavconn;/usr/lib/x86_64-linux-gnu/libboost_system.so;/usr/lib/x86_64-linux-gnu/libconsole_bridge.so")
